...
const sections: { h: string; body: React.ReactNode }[] = [
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        credits. Scenes are generated by the MiniMax H3 video model, accessed
        through third-party API providers; availability may be affected by
        those providers.
      </p>
    ),
  },
  ...
  },
  {
    ...
    body: (
      <>
        <p className="mb-3">
          Because the Service generates AI video, you agree not to use it to
          generate or attempt to generate:
        </p>
        <ul className="mb-3 list-disc space-y-1 pl-5">
          <li>
            <strong className="text-gray-200">Pornographic / NSFW content</strong>,
            including sexual or sexually suggestive material;
          </li>
          <li>
            <strong className="text-gray-200">Violence & gore</strong> —
            graphic depictions of violence, torture, or gore;
          </li>
          <li>
            <strong className="text-gray-200">Hate speech</strong> — content
            attacking people based on race, religion, gender, sexual
            orientation, disability, or other protected traits;
          </li>
          <li>
            <strong className="text-gray-200">Child-unsafe content</strong> —
            any sexualized or exploitative content involving minors (CSAM);
          </li>
          <li>
            <strong className="text-gray-200">Deepfakes / impersonation</strong> —
            AI-generated media impersonating real individuals or intended to
            deceive viewers about its origin;
          </li>
          <li>
            <strong className="text-gray-200">IP infringement</strong> —
            content violating third-party copyright, trademark, or privacy
            rights.
          </li>
        </ul>
        <p className="mb-3">
          <strong className="text-gray-200">Reporting:</strong> to report
          generated content that violates these rules, email
          lelea031210@gmail.com with the story URL; we review reports within 3
          business days.
        </p>
        <p className="mb-3">
          <strong className="text-gray-200">Moderation:</strong> prompts pass
          through the upstream model provider&apos;s content-safety filters,
          and we reserve the right to review, block, or remove prompts and
          generated scenes, and to suspend access for violations.
        </p>
